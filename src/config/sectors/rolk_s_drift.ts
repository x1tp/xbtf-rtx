...
export const ROLK_S_DRIFT_BLUEPRINT: SeizewellLayout = {
  ...
  asteroids: { count: 150, range: 1000, center: [0, 0, 0] },
  playerStart: [0, 0, 0],
  stations: [
    ...
    { name: 'BoFu Chemical Lab (M)', modelPath: '/models/00284.obj', position: [-200, -20, 100], scale: 30, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true },
    { name: 'Plankton Farm (M)', modelPath: '/models/00282.obj', position: [150, 20, -150], scale: 26, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true },
  ],
  gates: [
