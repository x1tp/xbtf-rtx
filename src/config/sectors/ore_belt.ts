...
export const ORE_BELT_BLUEPRINT: SeizewellLayout = {
  ...
  playerStart: [0, 0, 0],
  stations: [
    { name: 'Pirate Base', modelPath: '/models/00088.obj', position: [1000, 500, -2000], scale: 50, rotationAxis: 'y', rotationSpeed: 0.05, collisions: true }, // Placeholder
    ...
    { name: 'Silicon Mine (L)', modelPath: '/models/00294.obj', position: [500, -50, -500], scale: 50, rotationAxis: 'y', rotationSpeed: 0.005, collisions: true },
  ],
  gates: [
