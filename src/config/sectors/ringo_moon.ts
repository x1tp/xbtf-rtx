...
export const RINGO_MOON_BLUEPRINT: SeizewellLayout = {
  ...
  stations: [
    ...
    { name: 'Cattle Ranch (M)', modelPath: '/models/00182.obj', position: [-200, 30, -100], scale: 30, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true },
    { name: 'Cahoona Bakery (M)', modelPath: '/models/00183.obj', position: [100, -20, -300], scale: 30, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true },
  ],
  gates: [
