...
export const PARANID_PRIME_BLUEPRINT: SeizewellLayout = {
  ...
  stations: [
    ...
    { name: 'Paranid Trading Station', modelPath: '/models/00001.obj', position: [500, -100, -500], scale: 32, rotationAxis: 'z', rotationSpeed: -0.08, collisions: true },
    ...
    { name: '25MW Shield Fab (M)', modelPath: '/models/00135.obj', position: [-1000, 0, 1000], scale: 30, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true },
  ],
  gates: [
