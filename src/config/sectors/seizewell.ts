...
export const SEIZEWELL_BLUEPRINT: SeizewellLayout = {
    ...
    stations: [
        ...
        { name: 'Beta I.R.E. Laser Forge (alpha)', modelPath: '/models/00430.obj', position: [120, -200, 450], scale: 28, rotationAxis: 'y', rotationSpeed: 0.000, collisions: true },
        { name: 'Flower Farm (beta)', modelPath: '/models/00282.obj', position: [120, -20, 420], scale: 26, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true },
        { name: 'Flower Farm (gamma)', modelPath: '/models/00282.obj', position: [1120, 19, 308], scale: 26, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true },
        { name: 'Flower Farm (delta)', modelPath: '/models/00282.obj', position: [1190, 19, 380], scale: 26, rotationAxis: 'y', rotationSpeed: 0.00, collisions: true }
    ],
    gates: [
