...
export const XENON_SECTOR_9_BLUEPRINT: SeizewellLayout = {
  ...
  asteroids: { count: 300, range: 3000, center: [0, 0, 0] },
  playerStart: [0, 0, 0],
  stations: [
    ...
    { name: 'Xenon Station', modelPath: '/models/00444.obj', position: [-3000, 1000, -3000], scale: 45, rotationAxis: 'y', rotationSpeed: 0.02, collisions: true },
  ],
  gates: [
